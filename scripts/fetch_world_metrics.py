...
METRICS = [
    ...
    ("maternal_mortality", "SH.STA.MMRT", "Müttersterblichkeit", "ueberleben", "/100k", "down",
     "Todesfälle von Müttern je 100.000 Lebendgeburten.",
     "https://data.worldbank.org/indicator/SH.STA.MMRT", 25),
    ("undernourishment", "SN.ITK.DEFC.ZS", "Unterernährung", "ueberleben", "%", "down",
     "Anteil der Weltbevölkerung mit unzureichender Nahrungsenergie.",
     "https://data.worldbank.org/indicator/SN.ITK.DEFC.ZS", 35),
    ("safe_water", "SH.H2O.SMDW.ZS", "Sauberes Trinkwasser", "ueberleben", "%", "up",
     "Anteil der Menschen mit sicher verwaltetem Trinkwasser.",
     "https://data.worldbank.org/indicator/SH.H2O.SMDW.ZS", 55),
    ("internet_access", "IT.NET.USER.ZS", "Internetzugang", "wissen", "%", "up",
     "Anteil der Weltbevölkerung, der das Internet nutzt.",
     "https://data.worldbank.org/indicator/IT.NET.USER.ZS", 45),
    ("girls_school", "SE.SEC.NENR.FE", "Mädchen in weiterführender Schule", "wissen", "%", "up",
     "Netto-Einschulungsrate von Mädchen in weiterführenden Schulen.",
     "https://data.worldbank.org/indicator/SE.SEC.NENR.FE", 48),
    ("forest", "AG.LND.FRST.ZS", "Waldfläche", "planet", "%", "up",
     "Anteil der Landfläche, der mit Wald bedeckt ist.",
     "https://data.worldbank.org/indicator/AG.LND.FRST.ZS", 52),
]
