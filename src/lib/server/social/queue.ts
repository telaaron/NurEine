...
// Container bis FINISHED. Board-Blocker #322 (reel-regie, 2026-08-21, 3. Fall):
// mit dem bisherigen 25s-Timeout (für alle Media-Typen) publizierte igPublish
// regelmäßig, bevor der Container fertig war → Fehler 9007 "Media ID is not
// available". 100s statt 25s nur für REELS.
