...
<section class="mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-10 pt-8 sm:pt-10 lg:pt-16 pb-10 sm:pb-12">
	...
	<p
		class="mt-5 max-w-none sm:max-w-[55ch] text-[15px] sm:text-lg leading-relaxed rise rise-d2"
...
>
	<div class="mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-10 py-3 sm:py-4 flex flex-wrap items-center gap-4">
		<div class="flex flex-wrap items-center gap-2 flex-1">
			{#each cats as cat}
				<button
					type="button"
					onclick={() => (active = cat)}
					class="px-3 py-1.5 text-xs sm:text-sm rounded-full transition-all"
